...
export const applicationPageContent: ApplicationPageContent[] = [
  {
    ...
    overviewText: "Industrial humidity monitoring depends on the medium, measurement range, mounting method and output signal. For production rooms, ducts, HVAC and technical systems, stability, calibration, service access and compatibility with the control system are just as important as accuracy.",
  ...
  },
  {
    ...
    heroEyebrow: "Compressed air dew point testing",
    title: "Compressed air dew point testing and monitoring",
    lead: "Dew point meters, transmitters and hygrometers for compressed air dew point testing, dryer checks, OEM skids and dry process gases.",
    primaryButton: "Request a selection",
    secondaryButton: "View instruments",
    overviewEyebrow: "Application overview",
    overviewTitle: "Why dew point testing matters in compressed air",
    overviewText: "Compressed air dew point monitoring and testing show whether a dryer and distribution line are keeping moisture under control. Reliable monitoring helps protect pneumatic equipment, instruments, production processes and quality-critical applications.",
    rfqTitle: "What to specify in your request",
    ...
    highlights: [
      { icon: "sensor", title: "Dryer testing", text: "Continuous or periodic dew point testing after refrigerant or adsorption dryers." },
      { icon: "duct", title: "Pipeline test points", text: "Direct installation, sampling line or bypass according to process conditions." },
      { icon: "signal", title: "Alarm and output", text: "Local display, relay alarm and analog output for control systems." }
    ],
    processTitle: "How to choose a dew point testing instrument",
    processCards: [
      { title: "Testing target", text: "Define the expected dry range, alarm threshold and whether the task is permanent monitoring or service testing." },
    ...
    solutionsTitle: "Recommended instruments for compressed air dew point testing",
  ...
  },
  {
    ...
    heroEyebrow: "Glove box oxygen analysis",
    title: "Glove box and glovebox oxygen analysis",
    lead: "Oxygen analyzers for glove box and glovebox applications, nitrogen generators, gas purity checks, inert gas systems and low-ppm industrial monitoring.",
    primaryButton: "Request analyzer selection",
    secondaryButton: "View analyzers",
    overviewEyebrow: "Application overview",
    overviewTitle: "Where oxygen analyzers are used",
    overviewText: "An oxygen analyzer for glovebox applications helps confirm low O2 levels in glove boxes, inerting systems, gas generators and purity-sensitive processes. The right analyzer depends on range, sample condition, response time and integration needs.",
    rfqTitle: "What to specify in your request",
    rfqPoints: ["Gas background", "O2 range", "Pressure", "Sample flow", "Sampling point", "Display or alarm", "Output signal", "Documentation needs"],
    highlights: [
      { icon: "sensor", title: "Low-ppm oxygen", text: "Trace oxygen measurement for glove box, glovebox and inert gas environments." },
    ...
    solutionsTitle: "Suitable solutions",
    solutionTypes: ["Trace oxygen analyzers for glove box and glovebox monitoring", "Oxygen analyzers for nitrogen generators and gas purity checks", "Panel or portable systems for low-ppm oxygen measurement", "Industrial oxygen monitoring with alarms and signal outputs"],
    faqs: [
