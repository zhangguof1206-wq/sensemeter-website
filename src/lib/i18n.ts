...
export const copy = {
  ru: {
    ...
    categoriesLead: "Выберите бренд, измерительную задачу и условия установки: точка росы, влажность, температура или кислород, а при необходимости — совместимые комплектующие.",
