...
export const copy = {
  ru: {
    ...
    catalogLead:
      "Используйте каталог, чтобы сравнить приборы по диапазону измерения, рабочей среде, давлению, выходному сигналу и способу монтажа; затем откройте карточку для PDF datasheet и RFQ.",
