...
export const copy = {
  ru: {
    ...
    categoriesLead: "Выберите бренд и подходящую линейку приборов: точка росы, влажность, температура или кислород.",
  ...
  en: {
    ...
    categoriesLead: "Choose a brand and the right instrument family for dew point, humidity, temperature or oxygen.",
