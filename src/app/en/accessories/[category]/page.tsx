...
export async function generateMetadata({ params }: Props) {
  ...
  if (!category) return {};
  return staticPageMetadata({ locale: "en", path: `/accessories/${category.slug}`, title: category.title.en, description: category.summary.en, image: category.image });
}
...
export default async function Page({ params }: Props) {
  ...
  return <AccessoryCategoryPage category={category} products={getAccessoryProductsByCategory(category.slug)} locale="en" />;
}
