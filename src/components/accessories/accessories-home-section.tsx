      ...
      <div className="section-narrow">
        ...
        <div className="grid grid-cols-2 gap-x-5 gap-y-7 lg:grid-cols-3">
          {homeAccessoryProducts.map((product) => (
            ...
            >
              <div className="grid aspect-[4/3] place-items-center border border-line bg-white p-6 shadow-sm transition group-hover:border-accent/50 group-hover:shadow-md">
                <img
                  className="max-h-32 w-full max-w-[82%] object-contain transition duration-300 group-hover:scale-[1.03]"
                  src={product.image}
