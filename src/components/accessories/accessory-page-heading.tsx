...
export function AccessoryPageHeading({ title, lead, image, eyebrow, actionHref, actionLabel }: Props) {
  return (
    <section className="relative isolate overflow-hidden bg-steel px-5 py-16 text-white md:px-10 md:py-20">
      <img className="absolute inset-0 -z-20 h-full w-full object-cover opacity-70" src={image} alt="" aria-hidden="true" />
      <div
        className="absolute inset-0 -z-10"
        style={{ background: "linear-gradient(90deg, rgba(20, 31, 42, 0.96) 0%, rgba(20, 31, 42, 0.9) 42%, rgba(20, 31, 42, 0.45) 68%, rgba(20, 31, 42, 0.18) 100%)" }}
        aria-hidden="true"
      />
